...
export function MarkdownRenderer({
  ...
  return (
    <div
      className={cn(
        '[&_h1]:text-muted-foreground [&_h1]:mb-4 [&_h1]:font-mono [&_h1]:text-base [&_h1]:leading-tight [&_h1]:font-medium [&_h1]:uppercase',
        ...
        '[&_code]:text-accent-foreground [&_code]:bg-accent [&_code]:border-accent-foreground/20 [&_code]:rounded [&_code]:border [&_code]:px-1 [&_code]:font-mono [&_code]:text-sm',
        ...
        '[&_pre]:text-accent-foreground [&_pre]:bg-accent [&_pre]:border-accent-foreground/20 [&_pre]:rounded [&_pre]:border [&_pre]:px-4 [&_pre]:font-mono [&_pre]:text-sm [&_pre]:[&>code]:border-none',
        className,
      )}
